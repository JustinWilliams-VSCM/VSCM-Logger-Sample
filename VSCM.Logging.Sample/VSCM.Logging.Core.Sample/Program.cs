...
namespace VSCM.Logging.Core.Sample
{
    class Program
    {
    ...
    class Sample
    {
        ...
        private void Log(int decision3)
        {
            ...
            {
                case 1:
                    Logger.LogException("core sample test", "core sample test", new Exception("core sample test"), Guid.Empty);
                    break;
                case 2:
                    Logger.LogPerformance("core sample test", 1000, string.Empty, 0, 0, 0, "core sample test", string.Empty, string.Empty, Guid.Empty);
                    break;
                case 3:
                    Logger.LogTransmission(Guid.Empty, "0.0.0.0", 0, string.Empty, string.Empty, "core sample test", string.Empty, DateTime.Now, DateTime.Now, null);
                    break;
                case 4:
                    Logger.LogTransmissionData(ActionKind.Request, new { Test = "core sample test"}, Guid.Empty);
                    break;
            }
        }
    }
